...
AP statements automation
AP dashboard + Power BI reporting
...
Reason codes & action plan in Blackline
Cross-Functional:
TWS → Snowflake data ingestion
Balanced scorecard automation
Daily KPI & metrics automation
AI, POWER PLATFORM & WORKFLOW SOLUTIONS
User Access Provisioning 
Recognition Program 
IPM- Incident Problem Mgmt Error Classification
SharePoint/Power Automate workflows.
AKMS AI workflow tool onboarding.
AI Bot translation enablement..
Medius non-conforming invoice rejection automation.
DATA, ANALYTICS & REPORTING
Power BI dashboards: Payroll, PTP, CA, RTR, T&E, turnover, KPIs.
...
Azure migration and SAP system update support.
WiFi provider transition + added firewall layer for enhanced security.
...
SPOL migration to North America IT environment.
